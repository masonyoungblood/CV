...
#one-col-entry(
  content: [
    ...
    #v(-design-text-leading)
    #v(design-highlights-top-margin);#highlights([The Cultural Evolution Society \(CES\): Membership Secretary and Executive Committee Member: Sept 2025 -- present],[The Association of Early-Career Social Learning Researchers \(ESLR\): Web Secretary and Committee Member: Nov 2021 -- July 2025],[Animal Behavior Society: Twitter Management: Mar 2019 -- Aug 2020],)
  ],
)
...
#one-col-entry(
  content: [
    #strong[Alaka'i 1777 \(Installation\/Performance, 2025\)]

    #v(-design-text-leading)
    #two-col(left-column-width: design-highlights-summary-left-margin, right-column-width: 1fr, left-content: [], right-content: [#v(design-highlights-top-margin);#align(left, [Alaka'i 1777 is an immersive sound installation that uses machine learning to reconstruct the lost song culture of the Kaua’i ’ō’ō, an extinct Hawaiian bird, by weaving together archival recordings with interacting artificial agents.])], column-gutter: 0cm)

#v(-design-text-leading)  #v(design-highlights-top-margin);#highlights([Reforesters Laboratory, 24.2-channel audio \(Brooklyn, NY, June 21-22, 2025\)],[TechnoMirage, 8-channel audio \(New York, NY, Sept 21, 2025\)],[ṆEW INC and the New Museum's Creative Science Dinner at the Prospect Park Boathouse, 8-channel audio \(Brooklyn, NY, Oct 14, 2025\)],[25 Saint James Place, 8-channel audio \(New York, NY, Nov 20, 2025\)],[Something Fierce Festival at Flux Factory, 8-channel audio \(Queens, Nov 22-23, 2025\)],)
  ],
)
...
#one-col-entry(
  content: [
    #strong[Deep Listening for Nonhuman Perspective-Taking \(Workshop, 2024\)]

    #v(-design-text-leading)
    #two-col(left-column-width: design-highlights-summary-left-margin, right-column-width: 1fr, left-content: [], right-content: [#v(design-highlights-top-margin);#align(left, [Deep Listening for Nonhuman Perspective-Taking is a participatory, immersive sound workshop where participants listen deeply to diverse sounds of nonhuman life—infrasonic booms of whales, drumming displays of spiders, and complex songs of endangered and extinct birds.])], column-gutter: 0cm)

#v(-design-text-leading)  #v(design-highlights-top-margin);#highlights([University of St. Andrews \(St. Andrews, Scotland, July 10, 2024\)],[Hex House \(Brooklyn, NY, Dec 7, 2024\)],[The Bakery \(Brooklyn, NY, Mar 29, 2025\)],[Rutgers Art Network at Rutgers University \(New Brunswick, NJ, Oct 29, 2025\)],[25 Saint James Place \(New York, NY, Nov 20, 2025\)],)
  ],
)
